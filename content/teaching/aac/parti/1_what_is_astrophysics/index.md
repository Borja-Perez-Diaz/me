...
[![The Hubble tension.](/Images/H0_tension.jpg)](https://ui.adsabs.harvard.edu/abs/2021CQGra..38o3001D/abstract)
<a name="Fig1.1">
   Figure 1.1. Measurements of the Hubble Constant through different techniques (from Di Valentino et al. 2021), splitted into early Universe (upper part) and late Universe (lower part). Cyan vertical band shows the estimation from the SH0ES collaboration and the magenta one the estimation from the CMB. Panel (a): All recent measurements. Panel (b): only measurements with less than 3 km/s/Mpc of uncertainty are shown.
</a>
